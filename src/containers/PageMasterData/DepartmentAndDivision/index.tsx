...
import DepartmentAndDivisionProvider from './_provider'
import {
  SectionAction,
  SectionConfirm,
  SectionLoader,
...
export default function PageDepartmentAndDivision() {
...
const DepartmentAndDivision = styled.div`
