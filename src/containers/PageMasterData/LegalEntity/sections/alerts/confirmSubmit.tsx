...
import {
  updateLegalEntity,
  createLegalEntity,
} from 'src/api/legal-entity'
import { useLegalEntityContext } from '../../states/useContext'
...
export default function ConfirmSubmit() {
  ...
  const func = showModal === 'create' ? createLegalEntity : updateLegalEntity
  ...
  return (
    <Popup>
      ...
      <Typography.Title level={5} style={{ margin: 0, fontWeight: 'bold' }}>
        {isModuleCreate
          ? 'Are you sure want to save legal entity ?'
          : 'Are you sure want to update legal entity ?'
        }
      </Typography.Title>
      <div style={{ display: 'flex', gap: 10 }}>
        ...
        <Button
          ...
          className='hc-button'
          onClick={async () => {
            runProcess(`Wait for ${isModuleCreate ? 'submitting' : 'updating'} legal entity`)
