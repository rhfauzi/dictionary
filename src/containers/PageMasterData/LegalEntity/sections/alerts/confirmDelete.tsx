...
import { deleteLegalEntity } from 'src/api/legal-entity'
  ...
  return (
    <Popup onOutsideClick={() => handleConfirm(undefined)} >
      ...
      <Typography.Title level={5} style={{ margin: 0 }}>
        Are you sure to delete legal entity item
        <Popover>
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        ...
        <Button
          ...
          className='hc-button'
          onClick={() => {
            runProcess('Wait for deleting legal entity')
            try {
              deleteLegalEntity({ code: selectedRowKeys })
                .then(() => {
