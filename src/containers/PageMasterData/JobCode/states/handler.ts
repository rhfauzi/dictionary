...
export function baseHandler(state: StateType, dispatch: React.Dispatch<DispatchType>) {
  ...
  function handleDataOptJobTitle(payload: any) {
    dispatch({ type: 'optJobTitle', payload })
  }
  function handleDataOptLegalEntity(payload: any) {
    dispatch({ type: 'optLegalEntity', payload })
  }
  function handleDataOptCountry(payload: any) {
    dispatch({ type: 'optCountry', payload })
  }
  function handleDataOptJobFamily(payload: any) {
    dispatch({ type: 'optJobFamily', payload })
  }
  function handleDataJobFamily(payload: any) {
    dispatch({ type: 'datasJobFamily', payload })
  }
  function handleDataOptSubJobFamily(payload: any) {
    dispatch({ type: 'optSubJobfamily', payload })
  }
  function handleDataOptJobGrade(payload: any) {
    dispatch({ type: 'optJobGrade', payload })
  }
