...
export default function SectionCreateAndUpdate() {
  ...
  useEffect(() => {
    handleDisableButton(
      dataForm?.code === null || dataForm?.code === '' || typeof dataForm?.code === 'undefined'
      || dataForm?.name === null || dataForm?.name === '' || typeof dataForm?.name === 'undefined'
    ...
    <>
      ...
      >
        <Typography.Title level={3} style={{ margin: 0 }}>
          {isModalCreate ? 'Create Business Unit' : 'View Business Unit'}
        </Typography.Title>
