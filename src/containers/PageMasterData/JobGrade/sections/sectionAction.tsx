...
import { downloadTemplate, downloadData, uploadTemplate } from 'src/api/job-grade'
...
export default function SectionAction() {
  ...
  async function downloadDataAction() {
    try {
      ...
      link.href = url
      link.setAttribute('download', 'job-grade.xlsx')
  ...
  async function downloadTemplateAction() {
    try {
      ...
      const link = document.createElement('a')
      link.href = url
      link.setAttribute('download', 'template-job-grade.xlsx')
      document.body.appendChild(link)
      link.click()
      document.body.removeChild(link)
    } catch (error) {
