...
import { useCountryContext } from '../../states/useContext'
...
export default function ConfirmSubmit() {
  ...
  const func = showModal === 'create' ? createCountry : updateCountry
  ...
  return (
    <Popup>
      ...
      <Typography.Title level={5} style={{ margin: 0, fontWeight: 'bold' }}>
        {isModuleCreate
          ? 'Are you sure want to save country ?'
          : 'Are you sure want to update country ?'
        }
      </Typography.Title>
      <div style={{ display: 'flex', gap: 10 }}>
        ...
        <Button
          ...
          className='hc-button'
          onClick={async () => {
            runProcess(`Wait for ${isModuleCreate ? 'submitting' : 'updating'} country`)
