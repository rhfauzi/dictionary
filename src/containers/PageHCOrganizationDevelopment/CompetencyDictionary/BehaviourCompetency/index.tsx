...
import { createCompetency } from 'src/api/competency-dictionary/behaviour-competency'
...
export default function BehaviourCompetency() {
  ...
  useEffect(() => {
    const prevData = JSON.parse(localStorage.getItem('behaviour_competency')) ?? 0
