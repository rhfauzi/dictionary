...
import { downloadTemplate, downloadData, uploadTemplate } from 'src/api/business-unit'
...
export default function SectionAction() {
  ...
  async function downloadDataAction() {
    try {
      ...
      link.href = url
      link.setAttribute('download', 'business-unit.xlsx')
  ...
  async function downloadTemplateAction() {
    try {
      ...
      const link = document.createElement('a')
      link.href = url
      link.setAttribute('download', 'template-business-unit.xlsx')
      document.body.appendChild(link)
      link.click()
      document.body.removeChild(link)
    } catch (error) {
