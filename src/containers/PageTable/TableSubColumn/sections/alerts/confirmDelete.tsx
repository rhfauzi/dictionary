...
import { deleteBusinessUnit } from 'src/api/business-unit'
  ...
  return (
    <Popup onOutsideClick={() => handleConfirm(undefined)} >
      ...
      <Typography.Title level={5} style={{ margin: 0 }}>
        Are you sure to delete business unit item
        <Popover>
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        ...
        <Button
          ...
          className='hc-button'
          onClick={() => {
            runProcess('Wait for deleting business unit')
            try {
              deleteBusinessUnit({ code: selectedRowKeys })
                .then(() => {
