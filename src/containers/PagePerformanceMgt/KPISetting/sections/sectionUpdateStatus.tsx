...
import { changeStatusJobCode } from 'src/api/job-code'
...
export default function SectionUpdateStatus() {
  ...
  const handleChangeStatus = async () => {
    ...
    runProcess('Wait for updating Job Code')
    stopProcess()
  ...
  return (
    ...
    >
      ...
      <Typography.Title level={5} style={{ margin: 0 }}>
        {`Are you sure want to ${dataForm?.is_active ? 'activate' : 'inactivate'} this job code ?`}
      </Typography.Title>
